...
internal class CommandHelper
{
    ...
    public static Task ExecCommand(string rawCommand)
    {
        ...
        return ExecCommand(command, new[] { arguments });
    }

    public static Task ExecCommand(string[] rawCommands)
    {
        return ExecCommand(rawCommands[0], rawCommands[1..]);
    }
    ...
    public static async Task ExecCommand(string command, string[] arguments)
    {
        ...
        {
            Array.ForEach(arguments, p => processStartInfo.ArgumentList.Add(p));
        }
